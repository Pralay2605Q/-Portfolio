...
export default function Projects() {
  ...
  const projects = useMemo(
    () => [
      {
        title: "University MS",
        link: "https://github.com/Pralay2605Q/University-Management-System/",
        bgColor: "#0d4d3d",
        image: isMobile ? photo1 : img1,
      },
      {
        title: "Fitness",
        link: "https://github.com/Pralay2605Q/fitness?tab=readme-ov-file",
        bgColor: "#3884d3",
        image: isMobile ? photo2 : img2,
      },
      {
        title: "IMDB-CLONE",
        link: "https://pralay2605q.github.io/IMDB-CLONE/",
        bgColor: "#dc9317",
          ...
          <div>
            {projects.map((project, idx) => (
              <div
                ...
                style={{ width: "84%", maxWidth: "1200px" }}
              >
